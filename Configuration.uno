...
namespace RuterTest
{
	public static class Configuration
	{
		public static List<Watch> Watches = new List<Watch> {
			new Watch(07, 00, 08, 20, new Stop("St. Magnus Plass", 2310213), new List<string> {"435", "845", "848"}),
			...
			new Watch(08, 00, 08, 45, new Stop("Mosesvingen Øst", 2310315), new List<string> {"845", "435"}),
